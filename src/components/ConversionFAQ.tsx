...
const ConversionFAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our AI is trained on Canadian tribunal and court procedures across all provinces and territories. We run daily legal sweeps at 5am to stay on top of the latest changes. We cite specific forms and deadlines from official sources. However, laws can change — always double-check critical deadlines with the tribunal or court directly."
    },
    {
      id: "time",
